...
def parse_args():
    parser = argparse.ArgumentParser("Build dataset text-side asset inputs and BrainMosaic configs")
    parser.add_argument("--dataset-name", required=True)
    parser.add_argument("--eeg-root", type=Path, required=True)
...
def main():
    ...
    print(f"[OK] {args.dataset_name} text-side input files")
